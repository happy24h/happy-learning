...
import { getDetailInforDoctor } from '~/services/adminService';
...
class TeacherInfo extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            ...
            //  console.log('>>> hoi vanh get data from redux: ', this.props.allRequiredDoctorInfor);
            // console.log('>>>hoi vanh: data new: ', dataSelectPrice, dataSelectPayment, dataSelectProvince);
    ...
    render() {
        ...
        return (
            <div className="manage-doctor-container">
                <div className="manage-doctor-title">Thêm thông tin giáo viên</div>
                ...
                >
                    {this.state.hasOldData === true ? <span>Lưu thông tin</span> : <span>Thêm người dùng mới</span>}
                </button>
            </div>
        );
    }
